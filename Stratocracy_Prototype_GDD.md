...
fixtures, not shippable code. **Two crew modules exist and are deliberately
...
the statement that two modules were left out on purpose. `StratRules` contains
