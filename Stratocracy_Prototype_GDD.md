...
gate has not run — it asserts, and it is not green. **Fifteen of the thirty-one rows are ruled; the other
...
row 7 has not. **Row 2 is not green:** T-DATA-01..04 and 06 pass
